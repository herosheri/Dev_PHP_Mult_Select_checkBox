<?php include 'includes/includes_Menus.php'; ?>
  ...
  <script src="styl/bootstrap-multiselect.js"></script>
  <link rel="stylesheet" href="styl/bootstrap-multiselect.css" />
<div id="content">
  <div class="outer">
    ...
    <form method="post" id="fiche_form" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <select type="text" name="ref_cat[]" id="select_id" class="form-control multiple-select" multiple style="width: 570px;">
            ...
            <option value="<?php echo $rowhob['libele_cat']; ?>">
